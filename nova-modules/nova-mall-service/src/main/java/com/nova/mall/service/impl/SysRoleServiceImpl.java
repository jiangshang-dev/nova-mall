...
import com.nova.mall.entity.SysRole; import com.nova.mall.entity.SysRolePermission;
import com.nova.mall.exception.ServiceException;
import com.nova.mall.mapper.SysRoleMapper; import com.nova.mall.mapper.SysRolePermissionMapper;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
  ...
  @Override public Page<SysRole> pageRoles(long pageNum, long pageSize, String roleName) {
  ...
  public void createRole(SysRole role, List<Integer> permissionIds) {
    ...
    this.save(role); assignPermissions(role.getId(), permissionIds);
  }
  @Override @Transactional(rollbackFor = Exception.class)
  public void updateRole(SysRole role, List<Integer> permissionIds) {
    this.updateById(role); if (permissionIds != null) assignPermissions(role.getId(), permissionIds);
  }
  @Override @Transactional(rollbackFor = Exception.class)
  ...
  public void assignPermissions(Integer roleId, List<Integer> permissionIds) {
    ...
    for (Integer pid : permissionIds) {
      SysRolePermission rp = new SysRolePermission(); rp.setRoleId(roleId); rp.setPermissionId(pid); sysRolePermissionMapper.insert(rp);
    }
  }
  @Override public List<Integer> listPermissionIds(Integer roleId) {
